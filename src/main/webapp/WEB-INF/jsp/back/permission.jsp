                    ...
                    <section class="panel">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>钥匙列表，新增钥匙，用户管理，群组管理，商家管理，新增商家，角色管理，权限管理，商城使用情况，留言管理</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> 钥匙列表
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> 新增钥匙
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> 群组管理
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> 商家管理
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"> 新增商家
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="permissionName" class="col-lg-2 control-label">权限名称</label>
                        <div class="col-lg-10">
                            <input type="email" class="form-control" id="permissionName" placeholder="权限名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="permissionUrl" class="col-lg-2 control-label">权限路径</label>
                        <div class="col-lg-10">
                            <input type="password" class="form-control" id="permissionUrl" placeholder="权限路径">
                        </div>
                    </div>
                    <div class="form-group">
