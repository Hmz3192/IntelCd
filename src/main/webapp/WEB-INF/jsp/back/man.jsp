                    ...
                    <section class="panel">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-info" href="" title="Bootstrap 3 themes generator">操作</a>
                                        <a class="btn btn-info dropdown-toggle" data-toggle="dropdown" href=""
                                           title="Bootstrap 3 themes generator"><span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="#myModal" data-toggle="modal" title="Bootstrap 3 themes generator">查看好友</a></li>
                                            <li><a href="" title="Bootstrap 3 themes generator">查看用户黑名单</a></li>
                                            <li><a href="" title="Bootstrap 3 themes generator">修改信息</a></li>
                                            <li class="divider"></li>
                                            <li><a href="" title="Bootstrap 3 themes generator">删除</a></li>
                                        </ul>
                                    </div><!-- /btn-group --></td>
                            </tr>
                            <tr>
                        ...
                        <section class="panel">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>112</td>
                                    <td><a class="btn btn-info" href="" title="Bootstrap 3 themes generator">解除好友关系</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </section>
