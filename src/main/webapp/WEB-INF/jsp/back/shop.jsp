                                ...
                                <tr>
                                    ...
                                    <td><div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="#myModal" data-toggle="modal" title="Bootstrap 3 themes generator">查看商品</a></li>
                                            <li><a href="#"  title="Bootstrap 3 themes generator">编辑信息</a></li>
                                            <li class="divider"></li>
