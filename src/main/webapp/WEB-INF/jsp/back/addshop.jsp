...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> 新增商家</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <form class="form-horizontal " method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <p class="help-block">请选择商家图片</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">商家介绍：</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="商品介绍">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">商家位置：</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="商品价格">
                                        <span class="help-block">请填写准确的位置，如：xx小区-xx楼-xx号</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">经度：</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" placeholder="经度">
                                    </div>
                                    <label class="col-sm-2 control-label">纬度：</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" placeholder="纬度">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">请提交认证文件：</label>
                                    <div class="col-sm-10">
                                        <input type="file">
                                        <p class="help-block">请选择认证文件</p>
                                    </div>
                                </div>
                                <div class="form-group">
