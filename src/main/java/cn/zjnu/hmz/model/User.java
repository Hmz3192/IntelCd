...
public class User {
    ...
    public User(Integer id, String account, String name, String password, String picUrl, String sixPassword, String iphone, String email, String idCard, String cardPic) {
        this.id = id;
